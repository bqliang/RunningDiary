...
fun setMapType(mapView: MyMapView, mapType: Int) {
    mapView.map.mapType = mapType
}


@BindingAdapter("android:mapDimension")
fun setMapDimension(mapView: MyMapView, dimension: MyMapView.Dimension) {

    val angle = when (dimension) {
        MyMapView.Dimension.TWO -> 0f
        MyMapView.Dimension.THREE -> 45f
    }

    val cameraUpdate = CameraUpdateFactory.changeTilt(angle)
